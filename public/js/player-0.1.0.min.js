!(function (a, b) {
	...
	(d.DEBUG = !1),
		...
		(d.EVENTS = { READY: 'ready', PLAY: 'play', PAUSE: 'pause', ENDED: 'ended', TIMEUPDATE: 'timeupdate', PROGRESS: 'progress', ERROR: 'error' }),
		...
		(d.Player.prototype.init = function (c, e) {
			...
			d.isString(c) && (c = b.getElementById(c)),
				(this.elem = c),
				d.assert('IFRAME' === c.nodeName, 'playerjs.Player constructor requires an Iframe, got "' + c.nodeName + '"'),
				d.assert(c.src, "playerjs.Player constructor requires a Iframe with a 'src' attribute."),
		...
		(d.Player.prototype.on = function (a, b, c) {
			...
			return 'ready' === a ? this.keeper.one(d, a, b, c) : this.keeper.on(d, a, b, c), this.send({ method: 'addEventListener', value: a, listener: d }), !0;
		}),
		(d.Player.prototype.off = function (a, b) {
			var c = this.keeper.off(a, b);
			if ((d.log('Player.off', c), c.length > 0)) for (var e in c) return this.send({ method: 'removeEventListener', value: a, listener: c[e] }), !0;
			return !1;
		}),
	...
	d.addEvent(a, 'message', function (a) {
		...
		(d.Receiver.prototype.receive = function (b) {
			...
			if (-1 === d.indexOf(d.METHODS.all(), c.method)) return this.emit('error', { code: 2, msg: 'Invalid Method "' + c.method + '"' }), !1;
		...
		(d.Receiver.prototype.get = function (a, b, c) {
			var d = this;
			if (!this.methods.hasOwnProperty(a)) return this.emit('error', { code: 3, msg: 'Method Not Supported"' + a + '"' }), !1;
